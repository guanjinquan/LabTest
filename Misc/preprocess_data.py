...
if __name__ == "__main__":
    ...
    for outside_dir in os.listdir(input_dir):
        outside_dir = os.path.join(input_dir, outside_dir)
        for dir_name in os.listdir(outside_dir):
            pat_dir = os.path.join(outside_dir, dir_name)
